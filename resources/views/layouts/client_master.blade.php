...
<!-- Mirrored from themes.pixelstrap.com/bigdeal/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jul 2021 03:54:07 GMT -->
<head>
  ...
  <link rel="icon" href="{{ URL::to('frontend/images/favicon/favicon.png')}}" type="image/x-icon">
  <link rel="shortcut icon" href="{{ URL::to('frontend/images/favicon/favicon.png')}}" type="image/x-icon">
  ...
  <!--icon css-->
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/font-awesome.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/themify.css')}}">


  <!--Slick slider css-->
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/slick.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/slick-theme.css')}}">

  <!--Animate css-->
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/animate.css')}}">
  <!-- Bootstrap css -->
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/bootstrap.css')}}">

  <!-- Theme css -->
  <link rel="stylesheet" type="text/css" href="{{ URL::to('frontend/css/color2.css')}}" media="screen" id="color">
</head>
<body class="bg-light">
...
<div class="loader-wrapper">
  <div>
    <img src="{{ URL::to('frontend/images/loader.gif') }}" alt="loader">
  </div>
</div>
<!-- loader end -->
        ...
        <div class="main-menu-block">
          <div class="header-left">
            ...
            <div class="brand-logo logo-sm-center">
              <a href="index.html">
                <img src="{{ URL::to('frontend/images/layout-2/logo/logo.png') }}" class="img-fluid  " alt="logo">
              </a>
            </div>
          </div>
              ...
              <div class="nav-left" >
                ...
                <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                  <ul class="nav-cat title-font">
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/01.png') }}" alt="category-product"> western ware</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/02.png') }}" alt="category-product"> TV, Appliances</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/03.png') }}" alt="category-product"> Pets Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/04.png') }}" alt="category-product"> Car, Motorbike</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/05.png') }}" alt="category-product"> Industrial Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/06.png') }}" alt="category-product"> Beauty, Health Products</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/07.png') }}" alt="category-product"> Grocery Products </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/08.png') }}" alt="category-product"> Sports</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/09.png') }}" alt="category-product"> Bags, Luggage</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/10.png') }}" alt="category-product"> Movies, Music </a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/11.png') }}" alt="category-product"> Video Games</a></li>
                    <li> <a href="category-page(left-sidebar).html"><img src="{{ URL::to('frontend/images/layout-1/nav-img/12.png') }}" alt="category-product"> Toys, Baby Products</a></li>
                    <li>
                      ...
                      <li>
                        <div class="container">
                          ...
                          <div class="row menu-banner">
                            <div class="col-lg-6">
                              <div>
                                <img src="{{ URL::to('frontend/images/menu-banner1.jpg') }}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                            <div class="col-lg-6">
                              <div>
                                <img src="{{ URL::to('frontend/images/menu-banner2.jpg') }}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="container">
                          <div class="row">
                            ...
                            <div class="col mega-box product ">
                              <div class="mega-img">
                                <img src="{{ URL::to('frontend/images/mega-banner.jpg') }}" alt="menu-banner" class="img-fluid">
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="category-right">
              ...
              <div class="btn-group">
                ...
                <div class="dropdown-menu gift-dropdown">
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ URL::to('frontend/images/icon/1.png') }}" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Billion Days</h5>
                      <p><img src="{{ URL::to('frontend/images/icon/currency.png') }}" class="cash" alt="curancy"> Flat Rs. 270 Rewards</p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ URL::to('frontend/images/icon/2.png') }}" alt="Generic placeholder image" class="gift-bloc">
                    </div>
                    <div class="media-body">
                      <h5 class="mt-0">Fashion Discount</h5>
                      <p><img src="{{ URL::to('frontend/images/icon/fire.png') }}"  class="fire" alt="fire">Extra 10% off (upto Rs. 10,000*) </p>
                    </div>
                  </div>
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ URL::to('frontend/images/icon/3.png') }}" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ URL::to('frontend/images/icon/6.png') }}" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
                  ...
                  <div class="media">
                    <div  class="me-3">
                      <img src="{{ URL::to('frontend/images/icon/5.png') }}" alt="Generic placeholder image">
                    </div>
                    <div class="media-body">
          ...
          <div class="footer-main">
            <div class="footer-box">
              ...
              <div class="footer-contant">
                ...
                <ul class="paymant">
                  <li><a href="javascript:void(0)"><img src="{{ URL::to('frontend/images/layout-1/pay/1.png') }}" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="{{ URL::to('frontend/images/layout-1/pay/2.png') }}" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="{{ URL::to('frontend/images/layout-1/pay/3.png') }}" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="{{ URL::to('frontend/images/layout-1/pay/4.png') }}" class="img-fluid" alt="pay"></a></li>
                  <li><a href="javascript:void(0)"><img src="{{ URL::to('frontend/images/layout-1/pay/5.png') }}" class="img-fluid" alt="pay"></a></li>
                </ul>
              </div>
            </div>
            <div class="footer-box">
        ...
        <div class="news-latter">
          <div class="modal-bg">
            ...
            <div class="imd-wrraper">
                <img src="{{ URL::to('frontend/images/subscribe/1.jpg') }}" alt="newsletterimg" class="img-fluid bg-img">
            </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            <div class="quick-view-img">
              <img src="{{ URL::to('frontend/images/layout-1/product/3.jpg') }}" alt="" class="img-fluid bg-img">
            </div>
          </div>
                ...
                <div class="modal fade" id="sizemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body"><img src="{{ URL::to('frontend/images/size-chart.jpg') }}" alt="" class="img-fluid "></div>
                    </div>
                  </div>
                </div>
                <div class="size-box">
            ...
            <div class="media">
              <div class="img-wraper">
                <a href="product-page(left-sidebar).html">
                  <img src="{{ URL::to('frontend/images/layout-2/product/1.jpg') }}" alt="">
                </a>
              </div>
              <div class="media-body">
                <a href="product-page(left-sidebar).html">
    ...
    <div class="cart_media">
      <ul class="cart_product">
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ URL::to('frontend/images/layout-2/product/1.jpg') }}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
                <h4>redmi not 3</h4>
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ URL::to('frontend/images/layout-2/product/2.jpg') }}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
        ...
        <li>
          <div class="media">
            <a href="product-page(left-sidebar).html">
              <img alt="megastore1" class="me-3" src="{{ URL::to('frontend/images/layout-2/product/3.jpg') }}">
            </a>
            <div class="media-body">
              <a href="product-page(left-sidebar).html">
...
<div class="product-notification" id="dismiss">
  ...
  <div class="media">
    <img class="me-2" src="{{ URL::to('frontend/images/layout-1/product/5.jpg') }}" alt="Generic placeholder image">
    <div class="media-body">
...
<!-- slick js-->
<script src="{{ URL::to('frontend/js/slick.js') }}"></script>

<!-- popper js-->
<script src="{{ URL::to('frontend/js/popper.min.js') }}" ></script>
<script src="{{ URL::to('frontend/js/bootstrap-notify.min.j') }}s"></script>

<!-- menu js-->
<script src="{{ URL::to('frontend/js/menu.js') }}"></script>

<!-- timer js -->
<script src="{{ URL::to('frontend/js/timer2.js') }}"></script>

<!-- Bootstrap js-->
<script src="{{ URL::to('frontend/js/bootstrap.js') }}"></script>

<!-- tool tip js -->
<script src="{{ URL::to('frontend/js/tippy-popper.min.js') }}"></script>
<script src="{{ URL::to('frontend/js/tippy-bundle.iife.min.js') }}"></script>

<!-- father icon -->
<script src="{{ URL::to('frontend/js/feather.min.js') }}"></script>
<script src="{{ URL::to('frontend/js/feather-icon.js') }}"></script>

<!-- Theme js-->
<script src="{{ URL::to('frontend/js/modal.js') }}"></script>
<script src="{{ URL::to('frontend/js/script.js') }}"></script>
</body>

<!-- Mirrored from themes.pixelstrap.com/bigdeal/html/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 13 Jul 2021 03:57:46 GMT -->
</html>
